...
const CurrentURL4API = 'http://localhost:3001/Api'

export default function ProductInfo() {
  const [Recs, setRecs] = useState('')
  const [InputPicAPI, setInputPicAPI] = useState("C3RforKera230614010042739.png")
  const [InputPicURL, setInputPicURL] = useState('http://localhost:3001/Api/Doctors/GetFile/DrFatima230619124249603.png')
  ...
  // const [PicURL, setPicURL] = useState('http://192.168.1.100:8088/Api/Doctors/GetFile/DrFatima230619124249603.png')
  const [PicURL, setPicURL] = useState('http://localhost:3001/Api/Doctors/GetFile/DrFatima230619124249603.png')
